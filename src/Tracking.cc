...
{   
    ...
    if (mbRGB){
        cvtColor(originalBGR,originalBGR,cv::COLOR_RGB2BGR);
    }
    mnIdToBGRMap[mCurrentFrame.mnId] = originalBGR;//wanglian construct hashmap: mnid to originalRGB
